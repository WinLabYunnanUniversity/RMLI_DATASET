...
file_dir = 'F:/dataset/RML/RML2016.10b.dat'
...
model.load_state_dict(torch.load('./data/saved_Convnetmodel(rml2016b).pth', map_location=device))
model.eval()
...
savepath ='F:\dataset\RML\RML2016.10b_int'
